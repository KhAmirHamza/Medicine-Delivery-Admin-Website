...
class UpdateRider extends Component {
  count = 1;
  ...
  constructor(props) {
    ...
    if (id && this.count === 1) {
      var url = "https://api.hellometbd.com/rider?id=" + id;
      console.log(url);
      axios.get(url)
        .then(result => {
          ...
          this.setState({
            meta_data: {
                ...
                date_of_birth: rider.meta_data.date_of_birth,
    ...
    if (this.state.progressVisibility === "invisible") {
      ...
      if (this.state.id) {
        ...
        if (imageurl.includes("https:")) {
          ...
          this.updateRider(this.state.id, this.state.meta_data, this.state.auth); 
  ...
  updateRider(id, meta_data, auth) {
    console.log(this.state.meta_data.image_url);
    var rider = {_id: id, meta_data: meta_data, auth: auth};
    console.log("rider");
    console.log(rider);
    axios.patch("https://api.hellometbd.com/rider/"+id, rider)
    .then(result=>{
      console.log(result);
    ...
    return (
      <div >
          ...
          <Form >
            ...
            <Form.Group controlId="date_of_birth">
              <Form.Control
                ...
                value={this.state.meta_data.date_of_birth} />
            </Form.Group>
        ...
        <div className="d-flex justify-content-center">
          ...
          >
            {this.state.id !== null ? "Update Rider" : "Add Rider"}
          </Button>
        </div>
